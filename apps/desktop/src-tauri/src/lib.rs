...
pub fn run() {
    ...
    let mut builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cmd::mcp_server::update_mcp_server,
            cmd::mcp_server::delete_mcp_server,
            cmd::mcp_server::test_mcp_server_connection,
            cmd::mcp_server::mcp_server_workflow_references,
            cmd::mcp_server::start_mcp_server,
            cmd::mcp_server::stop_mcp_server,
            cmd::mcp_server::reconnect_mcp_server,
            cmd::mcp_server::authorize_mcp_server,
            ...
            cmd::workflow_catalog::get_workflows,
            cmd::workflow_catalog::create_workflow,
            cmd::workflow_catalog::get_workflow,
            cmd::workflow_catalog::update_workflow,
            // Python runtime
