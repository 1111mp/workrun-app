...
const TASK_NAME_USER: &str = "Workrun";
const TASK_NAME_ADMIN: &str = "Workrun (Admin)";
const TASK_XML_DIR: &str = "tasks";
const TASK_XML_USER: &str = "workrun-task-user.xml";
const TASK_XML_ADMIN: &str = "workrun-task-admin.xml";
...
async fn cleanup_legacy_shortcuts() -> Result<()> {
    ...
    let shortcut = startup_dir.join("Workrun.lnk");
